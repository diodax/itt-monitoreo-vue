...
<div>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><router-link :to="{ path: '/prescription' }">Prescription</router-link></li>
...
export default {
  ...
  methods: {
    submitForm () {
      let self = this;
      self.model.date = moment(self.model.startDate).format('YYYY-MM-DDTHH:mm:ss');
      api.post('/prescription', self.model).then(function(response) {
  ...
  notifications: {
    showAddSuccess: {
      ...
      message: 'Prescription creation complete',
